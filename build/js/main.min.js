...
var textBlocks = document.querySelectorAll('[data-about="text-block"]');
var aboutButton = document.querySelector('[data-about="button"]');
var modalWindow = document.querySelector('[data-modal="modal-window"]');
window.addEventListener('DOMContentLoaded', function () {
  var darkBackground = document.querySelector('.page--dark-background');
  ...
  window.addEventListener('load', function () {
    ...
    var onEscButtonPress = function onEscButtonPress(evt) {
      if (evt.key === 'Escape') {
    ...
    var onCloseButtonClick = function onCloseButtonClick(evt) {
      _modules_modals_init_modals__WEBPACK_IMPORTED_MODULE_1__["modals"].close('modal-window');
      darkBackground.classList.remove('page--dark-background--active');
      darkBackground.removeEventListener('click', onCloseButtonClick);
    };

    var onOpenButtonClick = function onOpenButtonClick() {
      _modules_modals_init_modals__WEBPACK_IMPORTED_MODULE_1__["modals"].open('modal-window');
      modalWindow.querySelectorAll('input').forEach(function (element) {
        element.value = '';
      });
...
if (window.window.innerWidth < 768) {
  ...
  document.querySelector('.catalog__title').textContent = "\u0422\u043E\u0432\u0430\u0440\u044B \u0438 \u0443\u0441\u043B\u0443\u0433\u0438 Smart\xA0Device";
  ...
  var onAccordionClick = function onAccordionClick(evt) {
    var accordionContainer = evt.target.closest('div');
...
var contactForms = document.querySelectorAll('[data-page="form"]');

var onModalSubmit = function onModalSubmit(evt) {
  var currentForm = evt.target.closest('form');
  evt.preventDefault();
  var regexpTel = /^\d+$/;
  var regexpName = /^[А-Яа-яa-zA-Z\s]*$/;
  var name = currentForm.querySelector('[data-form="contacts-form-name"]');
  var phone = currentForm.querySelector('[data-form="contacts-form-phone"]');
  ...
  if (valid) {
    currentForm.submit();
    localStorage.setItem('smart-device-data', JSON.stringify({
      name: name.value,
      phone: phone.value
    }));
  }
...
var smoothLinks = document.querySelectorAll('[data-page="smooth-link"]');
...
try {
  var _loop = function _loop() {
    ...
    smoothLink.addEventListener('click', function (e) {
      e.preventDefault();
      var targetLink = smoothLink.getAttribute('href').replace('#', '.');
